...
new AsyncDataResourceLoader()
    .addResource("data/poe_atlas_data-QWPTWU.json", [
        (resJson) => {
...
function setup(loader, resources) {
    ...
    loader
        ...
        .add("img/spritesheets/nodes_spritesheet12.json")
        .load(()=>{
            basesSheet = loader.resources["img/spritesheets/bases_spritesheet11.json"];
            nodesSheet = loader.resources["img/spritesheets/nodes_spritesheet12.json"];
